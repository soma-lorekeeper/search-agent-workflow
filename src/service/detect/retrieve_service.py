...
#
# 40인 근거(2026-08-20): Tier 3로 올라가며 임베딩 RPM이 3,000 → 5,000이 됐다.
# 40슬롯이면 약 61/초로 충전율 83/초 아래라 지속 가능하다(옛 24슬롯이 50/초 대비 갖던
# 비율과 같다). 자세한 산정은 src/common/llm_limit.py의 _EMBEDDING_CONCURRENCY 주석 참고.
# 다른 축도 여유롭다 — Neo4j 드라이버 풀 기본 100 중 40개(40%)를 쓴다.
_WORKERS = 40
